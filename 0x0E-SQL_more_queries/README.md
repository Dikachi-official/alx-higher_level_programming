...
<p>Type 'help;' or '\h' for help. Type '\c' to clear the current input statement.
...
<li>Starting MySQL database server mysqld $ $ cat 0-list_databases.sql | mysql -uroot -p
Database
information_schema
mysql
performance_schema
